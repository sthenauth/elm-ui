...
type alias OidcProvider =
    { provider_id : String, provider_name : String, logo_url : Maybe String }
...
encoder a =
    ...
    , ("logo_url" , Maybe.Extra.unwrap Json.Encode.null Json.Encode.string a.logo_url) ]
...
decoder =
    ...
    Json.Decode.Pipeline.required "logo_url" (Json.Decode.nullable Json.Decode.string)